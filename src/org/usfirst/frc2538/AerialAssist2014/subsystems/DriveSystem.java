...
public class DriveSystem extends Subsystem {
    ...
    public void driveMecanum(double x, double y, double z){
        //double throttleOutput = Robot.oi.driveJoystick.getThrottle();
        //double throttleProportion = throttleOutput*(-.25) + .25
        robotDrive41.mecanumDrive_Cartesian(x * Robot.oi.driveJoystick.getThrottle() * (-.25) + .25, y, z, 0);
        n++;
