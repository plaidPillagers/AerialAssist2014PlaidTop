...
public class Plaidapult extends Subsystem {
    ...
    SpeedController dummyTalon = RobotMap.plaidapultDummyTalon;
    ...
    public void firePlaidapult(){
        if(triggerReleased){
            //System.out.println("trigger moving forward!!!!!!!!!!");
            triggerActuator.set(DoubleSolenoid.Value.kForward);
        }
        else{
            //System.out.println("trigger moving backward************");
    ...
    public String displayTriggerState(){
        if(triggerReleased){
            return "LOCKED";
        }
        else{
